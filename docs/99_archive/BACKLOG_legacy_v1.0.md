...
- [x] **G-CBS v1.0: Implement closure_manifest + validate_closure_bundle + build_closure_bundle** — DoD: validator PASS on A1/A2 — Owner: antigravity
- [x] **G-CBS Invariant: Max 2 closure cycles then WAIVER or BLOCKED** — DoD: Hardcoded limit enforced — Owner: antigravity
- [x] **G-CBS: Enforce no forbidden tokens in closure artefacts** — DoD: Scan for ellipses, PENDING, TBD, TODO — Owner: antigravity
...
- [x] **OpenCode Sandbox Activation** — Why Next: Enable doc steward/builder via API; requested via Inbox
...
- [x] **Tier-3 Mission Dispatch Wiring Fixes v1.0** — DoD: validator PASS (G-CBS v1.1) — Date: 2026-01-13
