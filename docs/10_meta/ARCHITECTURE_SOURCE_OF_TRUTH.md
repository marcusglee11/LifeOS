...
| Canonical multi-agent protocol | `docs/02_protocols/LifeOS_Multi_Agent_Protocol_v1.0.md` | Active protocol reference — consolidates ratified DAP, transport envelope, and bilateral protocol components into single message schema and communication spec |
