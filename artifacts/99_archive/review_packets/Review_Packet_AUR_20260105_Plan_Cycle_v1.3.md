...
schema_version: "1.2"
created_at: "2026-01-06T17:32:00Z"
...
diff_summary: "Updated LifeOS Packet Schema to v1.2 with Plan Cycle support via subtypes (build_type=PLAN, review_type=PLAN_REVIEW). Implemented SemVer minor compatibility in validator. Added CURRENT schema alias. Taxonomy cleansed (9-core)."
verification_evidence: "pytest passed 20/20 tests. Validator validated v1.2 subtype logic. Protocol Hardening: Strict versioning (v1.3) implemented."
artifacts_produced:
...
# Review Packet: AUR_20260105 Plan Cycle Amendment (v1.3)
...
**Protocol Update (v1.3)**: Strict sequential versioning enforced. v1.2 archived.
...
```bash
python scripts/validate_packet.py artifacts/review_packets/Review_Packet_AUR_20260105_Plan_Cycle_v1.3.md --schema docs/02_protocols/lifeos_packet_schemas_CURRENT.yaml --ignore-skew
```
