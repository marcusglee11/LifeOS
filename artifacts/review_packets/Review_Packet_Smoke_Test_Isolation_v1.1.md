...
**PR Link**: <https://github.com/marcusglee11/LifeOS/pull/new/build/isolated-smoke-test-v1>
...
|----------|-------------|----------|
| **Provenance** | Code commit hash + message | [c352bdf] test(smoke): harden isolated worktree smoke (strict rc + path resolution + clean repo assert) |
...
| **Artifacts** | `Review_Packet_Smoke_Test_Isolation_v1.1.md` | [artifacts/review_packets/Review_Packet_Smoke_Test_Isolation_v1.1.md] |
