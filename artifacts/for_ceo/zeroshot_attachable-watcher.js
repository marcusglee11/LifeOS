...
const { AttachServer, socketDiscovery } = require('../src/attach');
...
// Socket path for attach - use centralized discovery logic (supports Windows pipes)
const socketPath = socketDiscovery.getTaskSocketPath(taskId);
