...
class TestToolInvokeRequestCompatibility:
    ...
    def test_from_dict_with_arguments_key(self):
        ...
        """
        payload = {"tool": "filesystem", "action": "read_file", "arguments": {"path": "README.md"}}
    ...
    def test_from_dict_with_args_key(self):
        ...
        payload = {"tool": "pytest", "action": "run", "args": {"target": "runtime/tests"}}
    ...
    def test_from_dict_empty_payload(self):
        ...
        payload = {"tool": "test", "action": "check"}
    ...
    def test_direct_construction_with_args(self):
        ...
        request = ToolInvokeRequest(
            tool="filesystem", action="write_file", args={"path": "out.txt", "content": "hello"}
        )
    ...
    def test_arguments_property_is_alias(self):
        ...
        request = ToolInvokeRequest(tool="test", action="run", args={"key": "value"})
