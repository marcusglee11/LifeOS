...
class TestProtectedPaths:
    ...
    def test_architecture_docs_protected(self):
        ...
        assert (
            is_protected("docs/03_runtime/LifeOS_Autonomous_Build_Loop_Architecture_v0.3.md")
            is True
        )
        assert (
            is_protected("docs/03_runtime/LifeOS_Autonomous_Build_Loop_Architecture_v0.2.md")
            is True
        )
