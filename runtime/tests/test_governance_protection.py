...
class TestGovernanceProtector(unittest.TestCase):
    ...
    def test_validate_scope_within_ceiling(self):
        ...
        scope = OperationScope(
            files_modified={"a.py", "b.py"}, directories_modified={"dir1"}, protected_violations=[]
        )
    ...
    def test_validate_mission_scope_valid(self):
        ...
        mission = {
            "safety": {
                "autonomy_ceiling": {"max_files_modified": 10, "max_directories_modified": 3}
            }
        }
    ...
    def test_validate_mission_scope_exceeds_ceiling(self):
        ...
        mission = {"safety": {"autonomy_ceiling": {"max_files_modified": 50}}}
