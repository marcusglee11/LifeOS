...
class TestFilesystemPathEnforcement:
    ...
    def test_filesystem_read_without_path_denied(self):
        ...
        request = ToolInvokeRequest(tool="filesystem", action="read_file", args={})
    ...
    def test_filesystem_write_without_path_denied(self):
        ...
        request = ToolInvokeRequest(tool="filesystem", action="write_file", args={})
    ...
    def test_filesystem_list_without_path_denied(self):
        ...
        request = ToolInvokeRequest(tool="filesystem", action="list_dir", args={})
...
class TestToolPolicyGovernance:
    ...
    def test_unknown_tool_denied(self):
        ...
        request = ToolInvokeRequest(tool="unknown_tool", action="some_action", args={})
    ...
    def test_unknown_action_denied(self):
        ...
        request = ToolInvokeRequest(tool="filesystem", action="delete_everything", args={})
