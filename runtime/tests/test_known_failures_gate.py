...
"""
        ...
        assert result == {"tests/test_foo.py::test_one", "tests/test_bar.py::TestClass::test_two"}
...
"""
        result = parse_failing_nodeids(output)
        assert result == {"tests/test_broken.py::test_fail_to_collect", "tests/conftest.py"}
...
"""
        ...
        assert sorted_result == ["a_test.py::test_a", "m_test.py::test_m", "z_test.py::test_z"]
