...
from runtime.util.context import _verify_hardware_context, _verify_time_pinning
...
class TestR65SubprocessIsolation:
    ...
    def test_verify_time_pinning_uses_pinned_subprocess(self):
        ...
        with patch(
            "coo_runtime.util.context.run_pinned_subprocess", return_value=mock_result
        ) as mock_run:
    ...
    def test_hardware_verification_routing(self):
        ...
        """
        pinned_context = {"kernel_version": "Linux 6.8", "cpu_microcode": "0x123"}
