...
class TestR65AMU0Capture:
    ...
    def test_atomic_capture_flow(self):
        ...
        with (
            ...
            patch(
                "coo_runtime.runtime.amu_capture.AMUCapture._snapshot_filesystem",
                return_value={"timestamp": "t"},
            ),
            patch("builtins.open", MagicMock()),
            patch(
                "coo_runtime.runtime.amu_capture.AMUCapture._verify_amu0_temp_hygiene"
            ) as mock_hygiene,
            patch(
                "coo_runtime.util.amu0_utils.calculate_canonical_hash",
            ...
            patch(
                "coo_runtime.runtime.amu_capture.run_pinned_subprocess",
                return_value=MagicMock(stdout="commit"),
            ),
    ...
    def test_hygiene_failure_symlink(self):
        ...
        """
        with (
            patch("os.walk", return_value=[("/tmp", [], ["link"])]),
