...
class TestCycle1V02PublicAPI:
    ...
    def test_ambiguous_validate_names_are_not_exported(self):
        ...
        with pytest.raises(ImportError):
            from runtime.mission import validate as _validate

            assert _validate is not None

        with pytest.raises(ImportError):
            from runtime.mission import validate_mission as _validate_mission

            assert _validate_mission is not None
