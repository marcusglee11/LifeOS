...
class TestCycle10ChairConditions:
    ...
    def test_metadata_enforces_size_limits(self):
        ...
        config = MissionBoundaryConfig(max_metadata_key_chars=5, max_metadata_value_chars=10)
        ...
        m_long_key = MissionDefinition.create(
            id="M1", name="T", goal="G", metadata={long_key: "val"}
        )
        ...
        m_long_val = MissionDefinition.create(
            id="M2", name="T", goal="G", metadata={"key": long_val}
        )
        ...
        m_many_pairs = MissionDefinition.create(
            id="M3", name="T", goal="G", metadata={"k1": "v1", "k2": "v2", "k3": "v3"}
        )
