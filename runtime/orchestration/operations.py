...
def validate_compensation(compensation_type: CompensationType, compensation_command: str) -> None:
    """
...
class OperationExecutor:
    ...
    def execute(
        ...
        validate_compensation(operation.compensation_type, operation.compensation_command)
    ...
    def _dispatch(self, operation: Operation, ctx: ExecutionContext) -> tuple[Any, Dict[str, Any]]:
    ...
    def _handle_llm_call(
        self, operation: Operation, ctx: ExecutionContext
    ...
    def _handle_gate_check(
        ...
        from runtime.orchestration.validation import GateValidationError, gate_check
