...
def is_valid(
    artifact_path: Path, context: Optional[Dict[str, Any]] = None, now: Optional[datetime] = None
) -> bool:
    """
...
def check_waiver_for_context(
    context: Dict[str, Any], now: Optional[datetime] = None, base_dir: Optional[Path] = None
) -> bool:
    """
