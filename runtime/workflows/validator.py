...
class WorkflowValidator:
    ...
    def __init__(
        self, max_steps: int = 5, max_human_steps: int = 2, allow_routine_human_ops: bool = False
    ):
        """
    ...
    def create_human_step(name: str, description: str, is_routine: bool = False) -> WorkflowStep:
        ...
        return WorkflowStep(
            name=name, actor=StepActor.HUMAN, description=description, is_routine=is_routine
        )
    ...
    def create_agent_step(name: str, description: str) -> WorkflowStep:
        ...
        return WorkflowStep(
            name=name, actor=StepActor.AGENT, description=description, is_routine=False
        )
    ...
    def create_system_step(name: str, description: str) -> WorkflowStep:
        ...
        return WorkflowStep(
            name=name, actor=StepActor.SYSTEM, description=description, is_routine=False
        )
