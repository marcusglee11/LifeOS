...
from runtime.governance.HASH_POLICY_v1 import hash_file
...
def validate_governance_surfaces(repo_root: str, manifest_path: str) -> Tuple[bool, List[str]]:
    """
...
def verify_manifest_signature(manifest_path: str, signature_path: str) -> bool:
    """
