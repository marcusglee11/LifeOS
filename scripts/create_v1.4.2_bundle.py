...
BUNDLE_NAME = "artifacts/bundles/Bundle_OpenCode_Steward_Hardening_CT2_v1.4.2.zip"
FILES = [
    ...
    "artifacts/evidence/opencode_steward_certification/HASH_MANIFEST_v1.4.2.json",
