...
BUNDLE_NAME = "artifacts/bundles/Bundle_OpenCode_Steward_Hardening_CT2_v1.4.zip"
FILES = [
    ...
    "artifacts/evidence/opencode_steward_certification/HASH_MANIFEST_v1.4.json",
    ...
    with zipfile.ZipFile(BUNDLE_NAME, 'w', zipfile.ZIP_DEFLATED) as zf:
        for file_path in FILES:
            if os.path.exists(file_path):
                # Archive name should match repo relative path to be clear, 
                # OR flatten them? 
                # Instructions usually imply structure. I will keep structure.
