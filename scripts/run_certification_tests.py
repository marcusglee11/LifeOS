...
def load_policy_module(repo_root: Path):
    spec = importlib.util.spec_from_file_location(
        "opencode_gate_policy", repo_root / POLICY_PATH.relative_to(REPO_ROOT)
    )
...
class TestRunner:
    ...
    def test_path_traversal_rejected(self) -> None:
        self.expect(
            ...
            lambda: self._expect_validation_failure(
                "M", "docs/../secrets.txt", self.policy.ReasonCode.PATH_TRAVERSAL_BLOCKED
            ),
        )
    ...
    def test_absolute_path_rejected(self) -> None:
        self.expect(
            ...
            lambda: self._expect_validation_failure(
                "A", "C:/Windows/System32/test.txt", self.policy.ReasonCode.PATH_ABSOLUTE_BLOCKED
            ),
        )
    ...
    def test_denylist_py_file(self) -> None:
        self.expect(
            ...
            lambda: self._expect_validation_failure(
                "M", "docs/example.py", self.policy.ReasonCode.DENYLIST_EXT_BLOCKED
            ),
        )
    ...
    def test_denylist_scripts(self) -> None:
        self.expect(
            ...
            lambda: self._expect_validation_failure(
                "M", "scripts/test.md", self.policy.ReasonCode.DENYLIST_ROOT_BLOCKED
            ),
        )
    ...
    def test_denylist_config(self) -> None:
        self.expect(
            ...
            lambda: self._expect_validation_failure(
                "A", "config/settings.yaml", self.policy.ReasonCode.DENYLIST_ROOT_BLOCKED
            ),
        )
    ...
    def test_denylist_gemini_md(self) -> None:
        self.expect(
            ...
            lambda: self._expect_validation_failure(
                "M", "GEMINI.md", self.policy.ReasonCode.DENYLIST_FILE_BLOCKED
            ),
        )
    ...
    def test_evidence_readonly(self) -> None:
        self.expect(
            ...
            lambda: self._expect_validation_failure(
                "A", "artifacts/evidence/test.json", self.policy.ReasonCode.OUTSIDE_ALLOWLIST_BLOCKED
            ),
        )
    ...
    def test_outside_allowed_roots(self) -> None:
        self.expect(
            ...
            lambda: self._expect_validation_failure(
                "M", "runtime/core.py", self.policy.ReasonCode.DENYLIST_EXT_BLOCKED
            ),
        )
