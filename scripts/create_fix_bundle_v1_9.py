...
def main():
    ...
    zip_name = "Bundle_OpenCode_Phase1_Fix_v1.9.zip"
    ...
    # Audit Report
    audit_report = evidence_dir / "Evidence_Audit_Gate_Report.txt"
    if not audit_report.exists():
        print("CRITICAL: Audit Report missing. Cannot bundle.")
        exit(1)

    # Locate Stream File
    target_stream_name = "b3be8cf794d6449c88da087a6545c774463d4b2802848fe0f23671e53c42c4e1.out"
    stream_file = evidence_dir / target_stream_name
    ...
    files_to_add = {
        ...
        audit_report: "Evidence_Audit_Gate_Report.txt",
